...
const Navbar = () => {
  return (
    <div className="w-full h-20 bg-white flex items-center justify-between max[411px]:px-9 px-6">
      ...
      <svg className="hidden cursor-pointer max-[768px]:inline" width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className=" flex items-center font-bold gap-9 max-[768px]:hidden">
