...
const Navbar = () => {
  return (
    <div className="w-[1440px] h-[80px] bg-white text-black flex items-center justify-between border-b-[1px] border-[#DEDFE2] max-[411px]:px-6 px-9">
      <div className="">
      ...
      <div className=" flex items-center font-bold gap-9 max-[411px]:hidden">
        <div className="text-[0.875rem]">Crypto Taxes</div>
        <div className="text-[0.875rem]">Free Tools</div>
        <div className="text-[0.875rem]">Resource Center</div>
        <div className=" py-2 px-4 bg-gradient-to-r from-[#2870EA] to-[#1B4AEF] text-white text-[0.875rem] rounded-md">Get Started</div>
      </div>
    </div>
  )
}
